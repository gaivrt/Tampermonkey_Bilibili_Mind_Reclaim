...
(function() {
    ...
    const QUOTES = [
        { text: "你随时可能离开生活。<br>让这种可能性决定你的所作、所言、所想。", author: "马可·奥勒留" },
        { text: "想一想你已经死去，你的生命已经结束。<br>把剩下的日子当作意外的礼物。", author: "马可·奥勒留" },
        { text: "并不是我们拥有的时间太少，<br>而是我们浪费的时间太多。", author: "塞内卡" },
        { text: "在此刻，活三天和活三世没有区别。<br>你失去的只能是当下。", author: "马可·奥勒留" },
        { text: "我们都在等待生活开始，<br>而在等待中，生命已经过去。", author: "塞内卡" },
        { text: "不要表现得好像你可以活一万年。", author: "马可·奥勒留" }
    ];
